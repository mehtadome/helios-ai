...
export default function Tier2Diagram() {
  return (
    <svg viewBox="0 0 760 310" width="100%" style={{ fontFamily: "inherit", overflow: "visible" }}>
      ...
      {/* App Server: x=230, y=20, w=160, h=54 */}
      <g filter="url(#ns2)">
      ...
      {/* Job Queue: x=230, y=168, w=160, h=52 */}
      <g filter="url(#ns2)">
      ...
      <line x1="140" y1="43" x2="230" y2="43" stroke={arrow} strokeWidth="1.5" markerEnd="url(#arr2)" />

      {/* 1b · App Server → Browser (no label) */}
      <line x1="230" y1="55" x2="140" y2="55" stroke={arrow} strokeWidth="1.5" markerEnd="url(#arr2)" />

      {/* 2 · App Server → HeyGen (no label) */}
      <line x1="390" y1="43" x2="580" y2="43" stroke={arrow} strokeWidth="1.5" markerEnd="url(#arr2)" />
      ...
      <line x1="295" y1="74" x2="295" y2="168" stroke={arrow} strokeWidth="1.5" markerEnd="url(#arr2)" />
